...
from ...views import (start_handler, contact_handler, message_handler, image_handler, inline_handler)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        updater = Updater("1718084619:AAFh2ZyRtb3ZJLyOaP4yfShISutw4zBQDcs")
